...
<div id="container">
    <div id="content" role="main">
        ...
        <h1 class="page-title"><?php
			echo wp_sprintf( esc_html__( 'Sermons Series: %s', 'sermon-manager-for-wordpress' ), '<span>' . esc_html( single_cat_title( '', false ) ) . '</span>' );
			?></h1>
		...
		<?php while ( have_posts() ) : the_post(); ?>
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <div class="entry-meta">
					<span
                            class="meta-prep meta-prep-author"><?php echo wp_sprintf( esc_html__( 'Preached on %s', 'sermon-manager-for-wordpress' ), sm_the_date( 'l, F j, Y' ) ); ?></span>
                    <span
