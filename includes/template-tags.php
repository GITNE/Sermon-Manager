...
function render_wpfc_sermon_archive() {
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        <h2 class="sermon-title"><a href="<?php the_permalink(); ?>"
                                    title="<?php wp_sprintf( esc_attr__( 'Permalink to %s', 'sermon-manager-for-wordpress' ), the_title_attribute( 'echo=0' ) ); ?>"
        ...
        <div class="wpfc_sermon_meta cf">
            ...
            <p><?php
				...
				wpfc_sermon_meta( 'bible_passage', '<span class="bible_passage">' . esc_html__( 'Bible Text: ', 'sermon-manager-for-wordpress' ), '</span> | ' );
				echo the_terms( $post->ID, 'wpfc_preacher', '<span class="preacher_name">', ' ', '</span>' );
				echo the_terms( $post->ID, 'wpfc_sermon_series', '<p><span class="sermon_series">' . esc_html__( 'Series: ', 'sermon-manager-for-wordpress' ), ' ', '</span></p>' );
				?>
            </p>
        </div>
    </div>
